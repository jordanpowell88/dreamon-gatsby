            ...
            <div className="row">
                <div className="col-md-12">
                    <div className="embed-responsive embed-responsive-16by9">
                        <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/hoD_q6UiLRM" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                    </div>
                    ...
                    <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=DMS79JZ3RVX3U" target="_blank" className="tem-btn nav-link move-eff"><span>donate now</span></a>
                    </div>
                </div>
            </div>
      </section>
