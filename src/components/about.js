...
const About = ({ about: { mission, missionDescription, history, historyDescription, coreValues, coreValueListItems, join, joinDescription, give, giveDescription, partner, partnerDescription, buttons, links } }) => {
  ...
  `)
    const image = getImage(data.aboutImage)
            ...
            <div className="row">
                <div className="col-md-4 col-sm-6">
                    <div className="service-content">
                        ...
                        <p>{joinDescription}</p>
                        <Link to={links.join} className="tem-btn move-eff"><span>{buttons.learnMoreButton}</span></Link>
                    </div>
                </div>
                <div className="col-md-4 col-sm-6">
                    <div className="service-content">
                        ...
                        <p>{giveDescription}</p>
                        <OutboundLink href={links.donate} className="tem-btn move-eff"><span>{buttons.learnMoreButton}</span></OutboundLink>
                    </div>
                </div>
                <div className="col-md-4 col-sm-12">
                    <div className="service-content mobile-auto">
                        ...
                        <OutboundLink href={links.donate} target="_blank" rel="noopener noreferrer" className="tem-btn nav-link move-eff"><span>{buttons.donateNowButton}</span></OutboundLink>
                    </div>
                </div>
            </div>
        </div>
