...
const Buckets = () => (
  <section className="donate-wraper">
    ...
    <div className="single-donate-wraper donate-wraper-bg-three">
        ...
        <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=SCJ6SAWVF5U5Q" target="_blank" rel="noopener noreferrer" className="tem-btn nav-link move-eff"><span>donate</span></a>
    </div>
  </section>
)
